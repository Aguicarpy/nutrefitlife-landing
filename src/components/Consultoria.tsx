    ...
    <section id="consultoria" className="relative py-32 bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid md:grid-cols-2 gap-20 items-center">
          ...
          >
            <span className="text-[10px] font-bold tracking-[0.4em] text-gray-400 mb-4 block uppercase">CONSULTORÍA</span>
            ...
            <p className="text-gray-500 mb-10 leading-relaxed font-light text-base max-w-md">
              {data.description}
            </p>
            ...
            <div className="space-y-8 mb-12">
              {data.features.map((item, i) => (
                <div key={i} className="flex items-start gap-6 group">
                  ...
                  <div>
                    <h3 className="text-xs font-bold tracking-widest mb-1 uppercase text-black">{item.title}</h3>
            ...
            <button
              ...
              className="px-10 py-4 bg-black text-white text-[10px] font-bold tracking-[0.2em] hover:bg-gray-800 transition-all active:scale-95"
            >
              AGENDAR CONSULTA
            </button>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-[4/5] bg-gray-50 flex items-center justify-center border border-gray-100 overflow-hidden relative group">
    {data.image ? (
      <motion.img 
        src={data.image} 
      ...
      <User size={180} strokeWidth={0.5} className="text-gray-200" />
            ...
            <motion.div 
              ...
              className="absolute -bottom-6 -right-6 bg-black text-white p-8 md:p-10 shadow-2xl"
            >
              <p className="text-[10px] font-bold tracking-[0.3em] text-gray-400 mb-3 uppercase">PROFESIONAL</p>
              <a 
